...
const rows = await connection.query(
  'SELECT PLYRNO, PLYRFNM, PLYRLNM, ACTVIND FROM CASINOLIB.PLYRMASTR WHERE PLYRNO = ?',
  ['123456']
)
```
...
SELECT PLYRNO, PLYRFNM, PLYRLNM FROM CASINOLIB/PLYRMASTR;
...
SELECT PLYRNO, TXNDATE, TXNAMT, TXNTYP FROM CASINOLIB.TXNHIST
...
SELECT PLYRNO, PLYRFNM, PLYRLNM, ACTVIND FROM CASINOLIB.PLYRMASTR
ORDER BY PLYRNO
